...
_GENERATERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lang', full_name='TTS.GenerateResponse.lang', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='version', full_name='TTS.GenerateResponse.version', index=7,
